...
def download_links_from_index():
    ...
    rootURL = 'https://www.government.is/news/$LisasticSearch/Search/?SearchQuery=&ContentTypes=&Themes=&Ministries=&Year=&PageIndex=&SortByDate=False'

    for pid in range (start_page+1,24):     #start page is 0

        pageURL = '{}{}{}'.format("https://www.government.is/news/$LisasticSearch/Search/?SearchQuery=&ContentTypes=&Themes=&Ministries=&Year=&PageIndex=", pid,"&SortByDate=False")
        print(pageURL)
